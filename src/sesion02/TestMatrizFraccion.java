...
public class TestMatrizFraccion {
	...
	public void testSumaProductoMatrices() {
		...
		Fraccion[][] suma = { { new Fraccion(17, 12), new Fraccion(22, 20), new Fraccion(27, 30) },
				{ new Fraccion(24, 12), new Fraccion(31, 20), new Fraccion(38, 30) },
				{ new Fraccion(31, 12), new Fraccion(40, 20), new Fraccion(49, 30) } };
		Fraccion[][] producto = { { new Fraccion(5760, 3840), new Fraccion(9000, 7500), new Fraccion(12960, 12960) },
				{ new Fraccion(8640, 3840), new Fraccion(13500, 7500), new Fraccion(19440, 12960) },
				{ new Fraccion(11520, 3840), new Fraccion(18000, 7500), new Fraccion(25920, 12960) } };
	...
	public void testSumaProductoMatricesConExcepcion() {
		...
		try {
			...
			fail("DeberÃa haber lanzado una excepciÃ³n");
		} catch (RuntimeException e) {
			assertEquals(e.getMessage(), "Las matrices no tienen el mismo tamaÃ±o");
		}
		try {
			MatrizFraccion matrizFraccion = new MatrizFraccion();
