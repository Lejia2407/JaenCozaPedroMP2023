...
public class TestEstudianteEmpleado {
	...
	@Test
	public void test() {
		Estudiante estudiante1 = new Estudiante("Francisco Rojas Alba", "Avd. Estación 5", "950224567",
				"frojas@gmail.com", 1);
		Estudiante estudiante2 = new Estudiante("Carmen Fernández Martín", "C. Perú 9", "9504134157", "cfermar@ual.es",
				2);
		Estudiante estudiante3 = new Estudiante("María González Segura", "Avd. Cabo de Gata 26 4º 1", "950234788",
				"mariags@gmail.com", 3);
		Profesor profesor1 = new Profesor("Antonio López Giménez", "C. Tirso de Molina 6", "950014678", "alopez@ual.es",
				"CITE II 224", 1500, new GregorianCalendar(2001, 0, 15), "Lunes y jueves de 10 a 12", 1);
		Profesor profesor2 = new Profesor("Ángeles Abad Martínez", "C. Cervantes 32", "950018987", "abad@ual.es",
				"CITE III 127", 1800, new GregorianCalendar(1998, 3, 25), "Lunes 10 a 15", 2);
		Profesor profesor3 = new Profesor("José García Perales", "C. Jacinto 12", "950019060", "jgarcia@ual.es",
				"CITE I 221", 2100, new GregorianCalendar(1995, 9, 1), "Viernes 10 a 15", 3);
		Administrativo administrativo = new Administrativo("Sergio Morales Parra", "Avd. Pablo Iglesias 78",
				"950017080", "smorales@ual.es", "Edificio Central 123", 1700, new GregorianCalendar(1990, 7, 23),
				"Becas");
